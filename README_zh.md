...
<table style="border-collapse: collapse; width: 100%; max-width: 1000px; text-align: center;">
  ...
  <tbody>
    <tr>
      <td style="padding: 12px; border: 1px solid #dee2e6; font-weight: bold; text-align: right;"><strong>否</strong></td>
    ...
    <tr>
      <td style="padding: 12px; border: 1px solid #dee2e6; font-weight: bold; text-align: center;"><strong>是</strong></td>
      <td style="padding: 10px; border: 1px solid #dee2e6;">
...
<table style="border-collapse: collapse; width: 100%; max-width: 1000px; text-align: center;">
  ...
  <tbody>
    <tr>
      <td style="padding: 12px; border: 1px solid #dee2e6; font-weight: bold; text-align: center;"><strong>否</strong></td>
      <td style="padding: 10px; border: 1px solid #dee2e6;">
