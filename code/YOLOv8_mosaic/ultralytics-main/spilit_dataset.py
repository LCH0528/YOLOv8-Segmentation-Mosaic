...
#数据集路径
images_dir=r"F:\学习\其他\其他\机器学习与深度学习\论文复现\计算机视觉\目标检测\YOLO\YOLOv8\ultralytics-main\dataset\images"
labels_dir=r"F:\学习\其他\其他\机器学习与深度学习\论文复现\计算机视觉\目标检测\YOLO\YOLOv8\ultralytics-main\dataset\labels"
#划分数据集，设置数据集数量占比
