...
# 定义路径
ROOT_DIR = './dataset/CHIP' # 请输入你文件的根目录
Image_DIR = os.path.join(ROOT_DIR, "images_jpg") # 目录底下包含图片
Label_DIR = os.path.join(ROOT_DIR, "masks") # 目录底下包含label文件
# 读取路径下的掩码
Label_files = os.listdir(Label_DIR)
# 指定png中index中对应的label
class_names = ['_background_', 'Hat', 'Hair', 'Glove', 'Sunglasses', 'UpperClothes', 'Dress', 'Coat', 'Socks',
'Pants', 'Torso-skin', 'Scarf', 'Skirt', 'Face', 'Left-arm', 'Right-arm',
'Left-leg', 'Right-leg', 'Left-shoe', 'Right-shoe']
# 分别表示label标注图中1对应Hat，2对应Hair...
for Label_filename in Label_files:
    ...
    # 保存在根目录下的json文件中
    full_path = '{}/json_labels/' + name + '.json'
